...
public class UiucQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q1RadioGroup = findViewById(R.id.uiucQ1RadioGroup);
        q2RadioGroup = findViewById(R.id.uiucQ2RadioGroup);
        q3RadioGroup = findViewById(R.id.uiucQ3RadioGroup);
        q4RadioGroup = findViewById(R.id.uiucQ4RadioGroup);


        final Button submitButton = findViewById(R.id.uiucSubmit);
        submitButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (q1Id == R.id.uiucQ1Correct) {
                    score++;
                }
                if (q2Id == R.id.uiucQ2Correct) {
                    score++;
                }
                if (q3Id == R.id.uiucQ3Correct) {
                    score++;
                }
                if (q4Id == R.id.uiucQ4Correct) {
                    score++;
                }
